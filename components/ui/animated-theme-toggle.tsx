...
export const AnimatedThemeToggle = ({ className, onChange }: { className?: string, onChange?: (isDark: boolean) => void }) => {
...
const SolarSwitch = ({ isDark }: { isDark: boolean }) => {
  ...
  // Sync motion values when state changes
  useEffect(() => {
