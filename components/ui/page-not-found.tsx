...
export default function NotFoundPage({ onGoBack, onGoHome }: { onGoBack?: () => void, onGoHome?: () => void }) {
  return (
...
function MessageDisplay({ onGoBack, onGoHome }: { onGoBack?: () => void, onGoHome?: () => void }) {
