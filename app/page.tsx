    ...
    <div className="nl-wrap" style={result ? { background: dm.bg, color: dm.text } : undefined}>
      ...
      <nav className="nl-nav" style={result ? { background: dm.navBg, borderColor: dm.border } : undefined}>
        ...
        <div className="nl-nav-right">
          ...
          <div className="nl-nav-divider" style={result ? { background: dm.border } : undefined} />

          <a
            href="https://www.linkedin.com/in/yash-prabhakar-67475b347/"
            target="_blank"
            rel="noopener noreferrer"
            className="nl-social-link"
            style={result ? { color: dm.muted } : undefined}
            title="LinkedIn"
          >
          ...
          <a
            href="https://github.com/YASH-HCKT"
            target="_blank"
            rel="noopener noreferrer"
            className="nl-social-link"
            style={result ? { color: dm.muted } : undefined}
